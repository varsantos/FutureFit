 ...
 */
	...
	$_POST['email']		=	$_POST['email']; // Validacao de existir pelo menos um '@' e um '.'
 ...
 */
	echo $sql = "INSERT INTO alunos ({$_campos}) VALUES ({$_valores})";
	...
	if ($resultado === TRUE) {
		header("location: conta.php?criar_conta=1");
	    // echo "New record created successfully";
	} else {
		header("location: conta.php?criar_conta=0");
